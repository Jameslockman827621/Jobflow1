          ...
          {mobileMenuOpen && (
            <div className="md:hidden absolute top-full left-0 right-0 bg-white border-b border-slate-200 shadow-lg py-4 px-4 space-y-4">
              ...
              <div className="pt-4 border-t border-slate-200 space-y-3">
                <Link href="/login" className="block w-full text-center py-3 text-base font-semibold text-navy-900" onClick={() => setMobileMenuOpen(false)}>Sign In</Link>
                <Link href="/login" className="block w-full text-center py-3 text-base font-semibold rounded-lg bg-navy-900 text-white hover:bg-navy-800 transition-all" onClick={() => setMobileMenuOpen(false)}>Get Started</Link>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-12 sm:mb-20">
            {features.map((feature, index) => (
              <div key={index} className="bg-white border border-slate-200 rounded-2xl shadow-md p-6 sm:p-8 hover:border-teal-300 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                ...
                <h3 className="text-xl sm:text-2xl font-semibold text-navy-900 mb-2 sm:mb-3">{feature.title}</h3>
                <p className="text-sm sm:text-base text-slate-600 mb-3 sm:mb-4 leading-relaxed">{feature.description}</p>
                <a href={feature.href} className="inline-flex items-center text-sm font-semibold text-teal-500 hover:text-teal-600 transition-colors">
                  Learn more
...
const features = [
  { title: "Smart Matching", description: "Our AI analyzes your skills, experience level, and preferences to surface opportunities you're genuinely qualified for.", href: "#", icon: "M13 10V3L4 14h7v7l9-11h-7z" },
  { title: "AI Applications", description: "Generate tailored resumes and cover letters for each application. Stand out with personalized, relevant content.", href: "#", icon: "M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" },
  { title: "Career Pathing", description: "See your career trajectory, identify skill gaps, and get actionable milestones to reach your next level.", href: "/career", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
  { title: "Analytics Dashboard", description: "Track application funnel, interview rates, and market trends. Make data-driven decisions about your search.", href: "/analytics", icon: "M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" },
  { title: "Company Reviews", description: "Read verified reviews from employees. Understand culture, compensation, and work-life balance before applying.", href: "/reviews", icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" },
  { title: "Interview Coach", description: "Practice with AI-powered mock interviews. Get real-time feedback on your responses and improve your delivery.", href: "#", icon: "M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" },
];
