      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-xl border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-8">
            ...
            <a href="#" className="text-sm text-slate-600 hover:text-navy-900 transition-colors">Pricing</a>
      ...
      <main className="pt-32 pb-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto text-center mb-20">
            {/* Badge */}
            <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-white border border-slate-200 shadow-md mb-8">
              <span className="w-2 h-2 rounded-full bg-teal-500"></span>
              <span className="text-xs font-medium tracking-wide text-slate-600">Production Ready — 20 Features Complete</span>
            </div>
            
            {/* Headline */}
            <h1 className="text-6xl md:text-7xl font-extrabold text-navy-900 mb-6 tracking-tight leading-tight">
            ...
            <div className="flex justify-center items-center space-x-4">
              <Link href="/login" className="px-8 py-3.5 text-base font-semibold rounded-lg bg-navy-900 text-white hover:bg-navy-800 transition-all shadow-md hover:shadow-lg">
                Start Free Trial
              </Link>
              <a href="http://localhost:8000/docs" target="_blank" rel="noopener noreferrer" className="px-8 py-3.5 text-base font-semibold rounded-lg border-2 border-slate-200 text-navy-900 hover:bg-slate-50 transition-colors">
                View Demo
              </a>
            </div>
            
            {/* Social Proof */}
            <p className="text-xs font-medium tracking-wide text-slate-600 mt-6">
              No credit card required · 5 free applications per month
            </p>
          </div>

          {/* Stats Bar */}
          <div className="bg-white border border-slate-200 rounded-2xl shadow-xl mb-20 overflow-hidden">
            <div className="grid grid-cols-4 divide-x divide-slate-200">
              <div className="py-8 text-center">
                <div className="text-4xl font-bold text-navy-900 mb-1">50+</div>
                <div className="text-xs font-medium tracking-wide text-slate-600">Companies Tracked</div>
              </div>
              <div className="py-8 text-center">
                <div className="text-4xl font-bold text-navy-900 mb-1">958</div>
                <div className="text-xs font-medium tracking-wide text-slate-600">Live Jobs</div>
              </div>
              <div className="py-8 text-center">
                <div className="text-4xl font-bold text-navy-900 mb-1">77%</div>
                <div className="text-xs font-medium tracking-wide text-slate-600">Match Accuracy</div>
              </div>
              <div className="py-8 text-center">
                <div className="text-4xl font-bold text-navy-900 mb-1">3</div>
          ...
          <div className="mb-20">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-navy-900 mb-4">Everything you need</h2>
              <p className="text-lg text-slate-600">From discovery to offer negotiation</p>
            </div>
            
            <div className="grid md:grid-cols-3 gap-6">
              {/* Feature 1 */}
              <div className="bg-white border border-slate-200 rounded-2xl shadow-md p-8 hover:border-teal-300 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                <div className="w-12 h-12 rounded-lg bg-navy-900 flex items-center justify-center mb-6">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                </div>
                <h3 className="text-2xl font-semibold text-navy-900 mb-3">Smart Matching</h3>
              ...
              {/* Feature 2 */}
              <div className="bg-white border border-slate-200 rounded-2xl shadow-md p-8 hover:border-teal-300 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                <div className="w-12 h-12 rounded-lg bg-teal-500 flex items-center justify-center mb-6">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                  </svg>
                </div>
                <h3 className="text-2xl font-semibold text-navy-900 mb-3">AI Applications</h3>
                <p className="text-base text-slate-600 mb-4 leading-relaxed">
              ...
              <div className="bg-white border border-slate-200 rounded-2xl shadow-md p-8 hover:border-teal-300 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                ...
                <h3 className="text-2xl font-semibold text-navy-900 mb-3">Career Pathing</h3>
                <p className="text-base text-slate-600 mb-4 leading-relaxed">
              ...
              <div className="bg-white border border-slate-200 rounded-2xl shadow-md p-8 hover:border-teal-300 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                ...
                <h3 className="text-2xl font-semibold text-navy-900 mb-3">Analytics Dashboard</h3>
                <p className="text-base text-slate-600 mb-4 leading-relaxed">
              ...
              <div className="bg-white border border-slate-200 rounded-2xl shadow-md p-8 hover:border-teal-300 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                ...
                <h3 className="text-2xl font-semibold text-navy-900 mb-3">Company Reviews</h3>
                <p className="text-base text-slate-600 mb-4 leading-relaxed">
              ...
              <div className="bg-white border border-slate-200 rounded-2xl shadow-md p-8 hover:border-teal-300 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                ...
                <h3 className="text-2xl font-semibold text-navy-900 mb-3">Interview Coach</h3>
                <p className="text-base text-slate-600 mb-4 leading-relaxed">
          ...
          {/* CTA Section */}
          <div className="bg-navy-900 rounded-2xl shadow-xl p-12 text-center">
            ...
            <Link href="/login" className="inline-block px-8 py-3.5 text-base font-semibold rounded-lg bg-teal-500 text-white hover:bg-teal-600 transition-all shadow-lg hover:shadow-xl">
              Get Started Free
            </Link>
          </div>
        </div>
