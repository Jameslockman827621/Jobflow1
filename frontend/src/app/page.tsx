...
const features = [
  {
    title: "Job Discovery",
    description:
      "Browse curated listings from top companies. Filter by role, location, and experience level to find positions worth your time.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Generate resumes and cover letters matched to each role. Highlight the experience that matters most for every application.",
    icon: (
      <svg className="w-5 h-5 text-teal-500" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description:
      "Follow every application from submission to offer. Know exactly where you stand with each company at a glance.",
    icon: (
      <svg className="w-5 h-5 text-teal-500" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description:
      "See how your background aligns with each listing. Understand where you're a strong fit and where to grow.",
    icon: (
      <svg className="w-5 h-5 text-teal-500" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description:
      "Read verified reviews and understand company culture, compensation, and work-life balance before you apply.",
    icon: (
      <svg className="w-5 h-5 text-teal-500" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description:
      "Practice with mock interviews tailored to your target role. Get structured feedback to sharpen your responses.",
    icon: (
      <svg className="w-5 h-5 text-teal-500" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="#features" className="text-sm text-slate-600 hover:text-navy-900 transition-colors">Features</a>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden absolute top-full left-0 right-0 bg-white border-b border-slate-200 shadow-lg py-4 px-4 space-y-3">
              <a href="#features" className="block py-2 text-sm text-slate-600 hover:text-navy-900 transition-colors" onClick={() => setMobileMenuOpen(false)}>Features</a>
      ...
      <main>
        {/* Hero */}
        <section className="pt-28 sm:pt-40 pb-16 sm:pb-24">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="text-display-lg text-navy-900 mb-5 sm:mb-6">
                Your next career move, simplified
              </h1>
              <p className="text-body-lg text-slate-600 max-w-2xl mx-auto mb-8 sm:mb-10 leading-relaxed">
                JobScale helps you find relevant opportunities, put together stronger applications, and stay organized from first click to final offer.
              </p>
              <div className="flex flex-col sm:flex-row justify-center items-center gap-3">
                <Link
                  href="/login"
                  className="w-full sm:w-auto px-6 py-3 text-sm font-medium rounded-lg bg-navy-900 text-white hover:bg-navy-800 transition-colors text-center"
                >
                  Get started free
                </Link>
                <a
                  ...
                  className="w-full sm:w-auto px-6 py-3 text-sm font-medium rounded-lg border border-slate-200 text-navy-900 hover:bg-slate-50 transition-colors text-center"
                >
                  View API docs
                </a>
              </div>
              <p className="text-caption text-slate-400 mt-5">
                Free tier includes 5 applications per month. No credit card required.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="features" className="pb-16 sm:pb-24">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-heading-xl text-navy-900 mb-3">Everything you need to run your search</h2>
              <p className="text-body-lg text-slate-500">From discovery to offer, in one place.</p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
              {features.map((feature) => (
                <div
                  key={feature.title}
                  className="bg-white border border-slate-200 rounded-xl p-6 hover:border-slate-300 hover:shadow-md transition-all duration-200"
                >
                  <div className="w-9 h-9 rounded-lg bg-navy-900/5 flex items-center justify-center mb-4">
                    {feature.icon}
                  </div>
        ...
        <section className="pb-16 sm:pb-24">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="bg-navy-900 rounded-xl px-6 sm:px-12 py-12 sm:py-16 text-center">
              <h2 className="text-heading-xl text-white mb-3">Start your search today</h2>
              <p className="text-body-lg text-slate-300 max-w-xl mx-auto mb-8">
                Set up your profile in a few minutes and see your first matched roles right away.
              </p>
              <Link
                href="/login"
                className="inline-block px-6 py-3 text-sm font-medium rounded-lg bg-teal-500 text-white hover:bg-teal-400 transition-colors"
              >
                Create your account
              </Link>
            </div>
